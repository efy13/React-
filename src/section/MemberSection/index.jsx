...
const MemberPanel = () => {
  return (
    <div className="container mx-auto px-10">
      ...
      >
        <h1 className="text-[96px] font-extrabold bg-[url(https://klbtheme.com/fynode/wp-content/uploads/2024/12/download.png)] bg-bg-cover  text-transparent bg-clip-text">
          Unleash the Power of
        </h1>
        <h2 className="text-[96px] font-extrabold bg-[url(https://klbtheme.com/fynode/wp-content/uploads/2024/12/download.png)] bg-bg-cover text-transparent bg-clip-text">
          Perfect Sound
        </h2>
